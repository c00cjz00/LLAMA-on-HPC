...
cp 13-RLHF_hf_datasets.py local/app/python/
...
bash -c 'export PATH=$PATH:$HOME/.local/bin; HUGGING_FACE_HUB_TOKEN=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 python 13-RLHF_hf_datasets.py'
