...
cp 12-SFT_hf_datasets.py local/app/python/
...
bash -c 'export PATH=$PATH:$HOME/.local/bin; HUGGING_FACE_HUB_TOKEN=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 python 12-SFT_hf_datasets.py'
